...
public class TodosResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TodosResponse other = (TodosResponse) obj;
        if ((id == null && other.id != null) || !id.equals(other.id))
            return false;
        if ((userUsername == null && other.userUsername != null) || !userUsername.equals(other.userUsername))
            return false;
    ...
    public String toString() {
        return "TodosResponse[" + "id=" + id + ", userUsername=" + userUsername + ", task=" + task + ", date=" + date + ", status=" + status + "]";
    }
